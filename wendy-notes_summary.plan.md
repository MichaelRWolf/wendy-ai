...
## Finalization
- Once all chunks are processed, consolidate the “Action Plan” content, ensure `notes-wendy_summary.md` matches the template, then export the finalized plan text to `wendy-notes_summary.plan.md` for reuse.
